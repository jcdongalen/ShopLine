...
public class ShippedAdapter extends RecyclerView.Adapter<ShippedAdapter.ShippedViewHolder> {
    private List<Order> shipped;
    ...
    public class ShippedViewHolder extends RecyclerView.ViewHolder {
        ...
        public ShippedViewHolder(View view) {
            super(view);
    ...
    public ShippedAdapter(Context context, List<Order> shipped) {
    ...
    @Override
    public ShippedAdapter.ShippedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_item_inquiry, parent, false);

        return new ShippedAdapter.ShippedViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ShippedAdapter.ShippedViewHolder holder, int position) {
        final Order order = shipped.get(position);
